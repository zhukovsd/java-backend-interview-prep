...
### 124. Есть набор справочников, которыми данные обогащаем. Справочники достаточно статичные. Храним их в БД. Мы хотим один раз из БД вытащить, у себя в словаре сохранить, потом использовать. Как это проще всего в Spring сделать?
### 125. Если у нас бин принимает значения null, его можно заинжектить?
### 126. Если несколько реализаций бина. @Primary и @Qualifier не прописаны, как поведет себя @Autowired?
### 127. Представь, что ты инжектишь к себе в Сервис Репозиторий. В поле написал Репозиторий, положил. Сверху Автовайред над полем. Сеттер к этому полю у тебя есть. Конструктор по умолчанию в Сервисе и ты хочешь вызвать через Конструктор Репозиторий и сделать getAll. Какие подводные камни?