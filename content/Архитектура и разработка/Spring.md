...
| ------------------------------------------------------------ | ---------------------------- | ---------------------------------------------------- |
| **Брошена RuntimeException**                                 | ✅ Да                         | Spring откатывает по умолчанию                       |
| **Брошена Error**                                            | ✅ Да                         | Расценивается как критическая ошибка                 |
| **Брошена Checked Exception** (Exception, IOException и др.) | ❌ Нет                        | Spring НЕ откатывает checked exceptions по умолчанию |
...
| **Поймано исключение, но вызывается setRollbackOnly()**      | ✅ Да                         | Ручной указатель отката                              |
| **Метод private / final / static**                           | ❌ Не работает @Transactional | Прокси не может обернуть метод                       |
| **Вызов метода внутри того же класса**                       | ❌ Не работает @Transactional | Self-invocation — прокси не используется             |
...
---
#### 37. Что такое ApplicationContext?
...
🔹 **Конфигурация (новый стиль, Spring Security 5.7+)**
