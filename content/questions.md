...
#### 2. [Что такое коллизия?](Основы-Java/java-core/#2-что-такое-коллизия) [3%]
#### 3. [Какие типы ссылок существуют в Java?](Основы-Java/java-core/#3-какие-типы-ссылок-существуют-в-java) [4%]
#### 4. [Какой класс называют Immutable?](Основы-Java/java-core/#4-какой-класс-называют-immutable) [12%]
...
#### 22. [Что такое enum?](Основы-Java/java-core/#22-что-такое-enum) [0%]
...
#### 21. [Как HashSet связан с HashMap?](Основы-Java/Collections/#21-как-hashset-связан-с-hashmap) [0%]
...
#### 24. [Процесс добавления объекта в HashSet?](Основы-Java/Collections/#24-процесс-добавления-объекта-в-hashset) [0%]
...
#### 28. [Назовите главные реализации Queue](Основы-Java/Collections/#28-назовите-главные-реализации-queue) [0%]
#### 29. [Что такое Dequeue?](Основы-Java/Collections/#29-что-такое-deque) [0%]
...
#### 32. [Какая коллекция реализует дисциплину обслуживания LIFO? FIFO?](Основы-Java/Collections/#32-какая-коллекция-реализует-дисциплину-обслуживания-lifo-fifo) [1%]
#### 33. [HashMap vs TreeMap](Основы-Java/Collections/#33-hashmap-vs-treemap) [3%]
#### 34. [Как с собой связаны Iterable и foreach?](Основы-Java/Collections/#34-как-с-собой-связаны-iterable-и-foreach) [1%]
#### 35. [Реализации интерфейса Map. Почему интерфейс Map выделен отдельно?](Основы-Java/Collections/#35-реализации-интерфейса-map-почему-интерфейс-map-выделен-отдельно) [5%]
#### 36. [Какую коллекцию использовать для уникальных отсортированных значений?](Основы-Java/Collections/#36-какую-коллекцию-использовать-для-уникальных-отсортированных-значений) [0%]
...
#### 40. [Структуры данных. Какая сложность в дереве?](Основы-Java/Collections/#40-структуры-данных-какая-сложность-в-дереве) [2%]
...
#### 10. [В каком порядке следует обрабатывать исключения в catch блоках?](Основы-Java/Exceptions/#10-в-каком-порядке-следует-обрабатывать-исключения-в-catch-блоках) [1%]
...
#### 15. [Зачем нужны volatile](Основы-Java/Multithreading/#15-зачем-нужны-volatile) [18%]
...
#### 11. [Чем WHERE отличается от HAVING? Можем ли мы их использовать в одном запросе?](Работа-с-базами-данных/SQL/#11-чем-where-отличается-от-having) [7%]
#### 12. [Чем отличается MySQL от PostgreSQL?](Работа-с-базами-данных/SQL/#12-чем-отличается-mysql-от-postgresql) [0%]
#### 13. [Оптимизация запросов. Какие инструменты?](Работа-с-базами-данных/SQL/#13-оптимизация-запросов-какие-инструменты) [21%]
#### 14. [EXPLAIN vs EXPLAIN ANALYZE](Работа-с-базами-данных/SQL/#14-explain-vs-explain-analyze) [11%]
#### 15. [PostgreSQL. Какой инструмент для сбора статистики? PGSTAT](Работа-с-базами-данных/SQL/#15-postgresql-какой-инструмент-для-сбора-статистики) [0%]
#### 16. [Что такое селективность?](Работа-с-базами-данных/SQL/#16-что-такое-селективность) [3%]
#### 17. [Ключевое слово LATERAL](Работа-с-базами-данных/SQL/#17-ключевое-слово-lateral) [0%]
#### 18. [Оконные функции. PARTITION BY](Работа-с-базами-данных/SQL/#18-оконные-функции-partition-by) [1%]
...
#### 23. [C помощью SQL блокировка строки? - SELECT FOR UPDATE](Работа-с-базами-данных/SQL/#23-c-помощью-sql-блокировка-строки---select-for-update) [5%]
#### 24. [UNION vs UNION ALL](Работа-с-базами-данных/SQL/#24-union-vs-union-all) [2%]
#### 25. [Расскажи про ключевое слово DISTINCT?](Работа-с-базами-данных/SQL/#25-расскажи-про-ключевое-слово-distinct) [1%]
#### 26. [Что такое табличные выражения?](Работа-с-базами-данных/SQL/#26-что-такое-табличные-выражения) [0%]
#### 27. [Для чего используется Database Connection Pool? (Hikari) Исчерпание connection pool](Работа-с-базами-данных/SQL/#27-для-чего-используется-database-connection-pool-hikari-исчерпание-connection-pool) [0%]
...
#### 13. [Проблема N + 1. Способы решения проблемы](Работа-с-базами-данных/ORM/#13-проблема-n--1-способы-решения-проблемы) [19%]
...
## [Spring](Архитектура-и-разработка/SPRING/#spring) [79%]
...
#### 9. [Скоуп бинов. Веб скоуп](Архитектура-и-разработка/SPRING/#9-скоуп-бинов-web-скоуп) [27%]
...
#### 5. [Unit тесты vs интеграционные тесты](Тестирование/Testing/#5-unit-тесты-vs-интеграционные-тесты) [1%]
