...
#### 9. [Как правильно выбрать индекс?](Работа-с-базами-данных/SQL/#9-как-правильно-выбрать-индекс) [13%]
...
#### 14. [Оптимизация запросов. Какие инструменты?](Работа-с-базами-данных/SQL/#14-оптимизация-запросов-какие-инструменты) [21%]
#### 15. [EXPLAIN vs EXPLAIN ANALYZE](Работа-с-базами-данных/SQL/#15-explain-vs-explain-analyze) [11%]
...
#### 28. [Для чего используется Database Connection Pool? (Hikari) Исчерпание connection pool](Работа-с-базами-данных/SQL/#28-для-чего-используется-database-connection-pool-hikari-исчерпание-connection-pool) [0%]
...
#### 6. [Распределение сообщений. Как сообщения распределяются по партициям?](Архитектура-и-разработка/Message-broker/#6-распределение-сообщений-как-сообщения-распределяются-по-партициям) [8%]
