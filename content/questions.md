...
## [SOLID](Принципы-и-методы-проектирования/SOLID/#solid) [21%]

#### 1. [Что такое SOLID(каждая буква)?](Принципы-и-методы-проектирования/SOLID/#1-что-такое-solidкаждая-буква) [21%]
...
#### 8. [JVM, JRE, JDK, JIT](Основы-Java/java-core/#8-jvm-jre-jdk-jit) [4%]
...
#### 11. [Области памяти Java. Stack и heap. Что это такое?](Основы-Java/java-core/#11-области-памяти-java) [16%]
#### 12. [Типы данных в Java](Основы-Java/java-core/#12-типы-данных-в-java) [1%]
...
#### 15. [Строки/String в Java? Из чего состоит? Нюансы](Основы-Java/java-core/#15-строкиstring-в-java-из-чего-состоит-нюансы) [4%]
...
#### 21. [Что такое конструктор?](Основы-Java/java-core/#21-что-такое-конструктор) [1%]
#### 22. [Какие есть модификаторы доступа? Какие применимы к классам?](Основы-Java/java-core/#22-какие-есть-модификаторы-доступа-какие-применимы-к-классам) [4%]
...
#### 27. [Что такое абстрактные классы?](Основы-Java/java-core/#27-что-такое-абстрактные-классы) [3%]
...
#### 39. [Record-ы с Java 17. Для чего и зачем?](Основы-Java/java-core/#39-record-ы-c-java-17-для-чего-и-зачем) [1%]
#### 40. [Что такое Анонимный класс](Основы-Java/java-core/#40-что-такое-анонимный-класс) [1%]
...
#### 2. [Что такое ArrayList?](Основы-Java/Collections/#2-что-такое-arraylist) [7%]
...
#### 4. [ArrayList. Что происходит под капотом при добавлении/удалении элемента в начало/середину/конец списка?](Основы-Java/Collections/#4-arraylist-что-происходит-под-капотом-при-добавленииудалении-элемента-в-началосерединуконец-списка) [7%]
...
#### 8. [LinkedList - сложность операций](Основы-Java/Collections/#8-linkedlist---сложность-операций) [5%]
...
#### 13. [Что такое HashMap?](Основы-Java/Collections/#13-что-такое-hashmap) [13%]
#### 14. [Внутреннее устройство HashMap](Основы-Java/Collections/#14-внутреннее-устройство-hashmap) [15%]
#### 15. [HashMap - сложность операций](Основы-Java/Collections/#15-hashmap---сложность-операций) [13%]
#### 16. [Процесс добавления объекта в HashMap](Основы-Java/Collections/#16-процесс-добавления-объекта-в-hashmap) [15%]
#### 17. [Будет ли работать HashMap, если все добавляемые ключи будут иметь одинаковый hashCode()?](Основы-Java/Collections/#17-будет-ли-работать-hashmap-если-все-добавляемые-ключи-будут-иметь-одинаковый-hashcode) [18%]
#### 18. [Ключи в HashMap](Основы-Java/Collections/#18-ключи-в-hashmap) [7%]
#### 19. [Что такое HashSet?](Основы-Java/Collections/#19-что-такое-hashset) [4%]
...
#### 31. [Какая коллекция реализует дисциплину обслуживания LIFO? FIFO?](Основы-Java/Collections/#36-какая-коллекция-реализует-дисциплину-обслуживания-lifo-fifo) [2%]
...
## [Исключения](Основы-Java/Exceptions/#Exceptions) [31%]
...
#### 4. [О чем говорит ключевое слово throws?](Основы-Java/Exceptions/#4-о-чем-говорит-ключевое-слово-throws) [1%]
...
#### 1. [Что такое дженерики? Для чего нужны?](Основы-Java/Generics/#1-что-такое-дженерики-для-чего-нужны) [10%]
...
#### 6. [Как JVM работает с Generics](Основы-Java/Generics/#6-как-jvm-работает-с-generics) [1%]
...
#### 5. [Что такое промежуточные методы? Какие промежуточные методы в стримах вы знаете](Основы-Java/Stream-API/#5-что-такое-промежуточные-методы-какие-промежуточные-методы-в-стримах-вы-знаете) [7%]
#### 6. [Что такое терминальные методы? Какие терминальные методы в стримах вы знаете](Основы-Java/Stream-API/#6-что-такое-терминальные-методы-какие-терминальные-методы-в-стримах-вы-знаете) [10%]
#### 7. [Методы в Stream API](Основы-Java/Stream-API/#7-методы-в-stream-api) [0%]
#### 8. [Расскажите про класс Collectors и его методы](Основы-Java/Stream-API/#8-расскажите-про-класс-collectors-и-его-методы) [1%]
...
#### 12. [Что такое параллельные стримы?](Основы-Java/Stream-API/#12-что-такое-параллельные-стримы) [4%]
#### 13. [Какая разница между findAny() и findFirst()](Основы-Java/Stream-API/#13-какая-разница-между-findany-и-findfirst) [2%]                          
...
#### 8. [Как работать с коллекциями в многопоточном программировании?](Основы-Java/Multithreading/#8-как-работать-с-коллекциями-в-многопоточном-программировании) [4%]
...
#### 11. [Что такое Livelock](Основы-Java/Multithreading/#11-что-такое-livelock) [5%]
#### 12. [Что такое Race condition](Основы-Java/Multithreading/#12-что-такое-race-condition) [8%]
...
#### 18. [Какими способами можем запустить несколько потоков в Java приложении? Как запустить поток в Java?](Основы-Java/Multithreading/#18-какими-способами-можем-запустить-несколько-потоков-в-java-приложении-как-запустить-поток-в-java) [9%]
#### 19. [Что за интерфейсы Runnable и Callable? В чем между ними отличия?](Основы-Java/Multithreading/#19-что-за-интерфейсы-runnable-и-callable-в-чем-между-ними-отличия) [5%]
...
## [Базы данных](Работа-с-базами-данных/Database-management-system/#database-management-system) [15%]
...
#### 4. [Что такое шардирование?](Работа-с-базами-данных/Database-management-system/#4-что-такое-шардирование) [7%]
...
## [SQL](Работа-с-базами-данных/SQL/#sql) [77%]
...
#### 3. [Проблемы параллельных транзакций](Работа-с-базами-данных/SQL/#3-проблемы-параллельных-транзакций) [4%]
...
#### 5. [Виды JOIN. Как работает каждый JOIN?](Работа-с-базами-данных/SQL/#5-виды-join-как-работает-каждый-join) [16%]
#### 6. [Индексы в SQL. Что это?](Работа-с-базами-данных/SQL/#6-индексы-в-sql-что-это) [24%]
...
#### 9. [Нормализация и денормализация. Перечислите формы](Работа-с-базами-данных/SQL/#9-нормализация-и-денормализация-перечислите-формы) [7%]
#### 10. [Что такое внешний ключ?](Работа-с-базами-данных/SQL/#10-что-такое-внешний-ключ) [0%]
#### 11. [Чем WHERE отличается от HAVING? Можем ли мы их использовать в одном запросе?](Работа-с-базами-данных/SQL/#11-чем-where-отличается-от-having) [10%]
#### 12. [Чем отличается MySQL от PostgreSQL?](Работа-с-базами-данных/SQL/#12-чем-отличается-mysql-от-postgresql) [0%]
#### 13. [Оптимизация запросов. Какие инструменты?](Работа-с-базами-данных/SQL/#13-оптимизация-запросов-какие-инструменты) [19%]
#### 14. [EXPLAIN vs EXPLAIN ANALYZE](Работа-с-базами-данных/SQL/#14-explain-vs-explain-analyze) [13%]
...
#### 20. [Хранимые процедуры](Работа-с-базами-данных/SQL/#20-хранимые-процедуры) [3%]
...
#### 30. [Primary Key](Работа-с-базами-данных/SQL/#30-primary-key) [4%]
...
## [NoSQL](Работа-с-базами-данных/NoSQL/#nosql) [3%]
...
## [ORM](Работа-с-базами-данных/ORM/#orm) [52%]

#### 1. [Что такое Hibernate, JPA, JDBC, ORM?](Работа-с-базами-данных/ORM/#1-что-такое-hibernate-jpa-jdbc-orm) [8%]
...
#### 8. [FetchType](Работа-с-базами-данных/ORM/#8-fetchtype) [1%]
...
#### 12. [EntityManager + EntityManagerFactory / SessionFactory + session](Работа-с-базами-данных/ORM/#12-entitymanager--entitymanagerfactory--sessionfactory--session) [3%]
#### 13. [Проблема N + 1. Способы решения проблемы](Работа-с-базами-данных/ORM/#13-проблема-n--1-способы-решения-проблемы) [24%]
...
#### 1. [Зачем мы используем Spring? Почему его так любят?](Архитектура-и-разработка/SPRING/#1-зачем-мы-используем-spring-почему-его-так-любят) [16%]
#### 2. [Inversion of Control](Архитектура-и-разработка/SPRING/#2-inversion-of-control) [13%]
#### 3. [Dependency Injection](Архитектура-и-разработка/SPRING/#3-dependency-injection) [17%]
...
#### 7. [@Qualifier vs @Primary](Архитектура-и-разработка/SPRING/#7-qualifier-vs-primary) [19%]
#### 8. [Что такое Bean?](Архитектура-и-разработка/SPRING/#8-что-такое-bean) [13%]
...
#### 15. [@Controller и @RestController](Архитектура-и-разработка/SPRING/#15-controller-и-restcontroller) [10%]
...
#### 18. [Парадигма AOP](Архитектура-и-разработка/SPRING/#18-парадигма-aop) [4%]
#### 19. [Циклическая зависимость](Архитектура-и-разработка/SPRING/#19-циклическая-зависимость) [7%]
#### 20. [Spring Boot](Архитектура-и-разработка/SPRING/#20-spring-boot) [9%]
...
#### 25. [@Transactional. Как работает?](Архитектура-и-разработка/SPRING/#25-transactional-как-работает) [30%]
#### 26. [Атрибут propagation у @Transactional](Архитектура-и-разработка/SPRING/#26-атрибут-propagation-у-transactional) [11%]
#### 27. [@Transaction Что будет если вызвать метод из метода в одном классе при различных сценариях](Архитектура-и-разработка/SPRING/#27-transaction-что-будет-если-вызвать-метод-из-метода-в-одном-классе-при-различных-сценариях) [10%]
...
#### 46. [Виды proxy в Spring](Архитектура-и-разработка/SPRING/#46-виды-proxy-в-spring) [3%]
#### 47. [@Lookup](Архитектура-и-разработка/SPRING/#47-lookup) [3%]
...
#### 12. [Плюсы и минусы паттерна Singleton?](Принципы-и-методы-проектирования/Design-Patterns/#12-плюсы-и-минусы-паттерна-singleton) [4%]
...
#### 5. [REST vs RPC. Как выбрать что лучше подходит?](Архитектура-и-разработка/WEB/#5-rest-vs-rpc-как-выбрать-что-лучше-подходит) [4%]
...
#### 2. [Паттерн Saga в микросервисной архитектуре](Архитектура-и-разработка/Microservices/#2-паттерн-saga-в-микросервисной-архитектуре) [7%]
...
#### 11. [Брокеры сообщений vs Rest](Архитектура-и-разработка/Message-broker/#11-брокеры-сообщений-vs-rest) [4%]
...
#### 18. [Смещение (offset) в Kafka](Архитектура-и-разработка/Message-broker/#18-смещение-offset-в-kafka) [1%]
...
## [Другое](Прочее/Other/#other) [11%]

#### 1. [Инструменты для отладки приложения, течет память, все замирает - Visual VM, JMap, профилировщики](Прочее/Other/#1-инструменты-для-отладки-приложения-течет-память-все-замирает---visual-vm-jmap-профилировщики) [1%]
