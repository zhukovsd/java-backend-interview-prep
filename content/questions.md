...
#### 11. [Как работает GC?](Основы-Java/java-core/#11-как-работает-gc) [14%]
#### 12. [Какие виды GC знаешь?](Основы-Java/java-core/#12-какие-виды-gc-знаешь) [6%]
#### 13. [Области памяти Java. Stack и heap. Что это такое?](Основы-Java/java-core/#13-области-памяти-java) [16%]
...
#### 17. [Строки/String в Java? Из чего состоит? Нюансы](Основы-Java/java-core/#17-строкиstring-в-java-из-чего-состоит-нюансы) [6%]
...
#### 31. [Отличия интерфейса от абстрактных классов?](Основы-Java/java-core/#31-отличия-интерфейса-от-абстрактных-классов) [13%]
...
#### 16. [Что такое бакет? Внутреннее устройство бакета](Основы-Java/Collections/#16-что-такое-бакет-внутреннее-устройство-бакета) [6%]
#### 17. [HashMap - сложность операций](Основы-Java/Collections/#17-hashmap---сложность-операций) [12%]
#### 18. [Процесс добавления объекта в HashMap](Основы-Java/Collections/#18-процесс-добавления-объекта-в-hashmap) [12%]
...
#### 38. [Реализации интерфейса Map. Почему интерфейс Map выделен отдельно?](Основы-Java/Collections/#38-реализации-интерфейса-map-почему-интерфейс-map-выделен-отдельно) [5%]
...
#### 42. [LinkedHashMap](Основы-Java/Collections/#42-linkedhashmap) [2%]
...
#### 3. [Какие встроенные функциональные интерфейсы вы знаете?](Основы-Java/Functional-Interface/#3-какие-встроенные-функциональные-интерфейсы-вы-знаете) [4%]
...
#### 4. [Типы методов в Stream API](Основы-Java/Stream-API/#4-типы-методов-в-stream-api) [10%]
...
#### 8. [Чем отличаются методы map() и flatMap()?](Основы-Java/Stream-API/#8-чем-отличаются-методы-map-и-flatmap) [8%]
...
#### 11. [Что такое Deadlock](Основы-Java/Multithreading/#11-что-такое-deadlock) [10%]
#### 12. [Что такое Livelock](Основы-Java/Multithreading/#12-что-такое-livelock) [3%]
#### 13. [Что такое Race condition](Основы-Java/Multithreading/#13-что-такое-race-condition) [7%]
#### 14. [Atomic vs Volatile. Что это и когда использовать?](Основы-Java/Multithreading/#14-atomic-vs-volatile-что-это-и-когда-использовать) [5%]
...
#### 18. [Collections.synchronizedMap vs ConcurrentHashMap](Основы-Java/Multithreading/#18-collectionssynchronizedmap-vs-concurrenthashmap) [2%]
...
#### 30. [Что такое happens-before?](Основы-Java/Multithreading/#30-что-такое-happens-before) [5%]
...
#### 1. [Виды БД и для чего их лучше использовать?](Работа-с-базами-данных/Database-management-system/#1-виды-бд-и-для-чего-их-лучше-использовать) [2%]
...
#### 4. [Уровни изолированности (read uncommitted, read committed, repeatable read, serializable)](Работа-с-базами-данных/SQL/#4-уровни-изолированности-read-uncommitted-read-committed-repeatable-read-serializable) [23%]
#### 5. [Виды JOIN. Как работает каждый JOIN?](Работа-с-базами-данных/SQL/#5-виды-join-как-работает-каждый-join) [14%]
#### 6. [Индексы в SQL. Что это?](Работа-с-базами-данных/SQL/#6-индексы-в-sql-что-это) [21%]
#### 7. [Почему когда много индексов, это плохо?](Работа-с-базами-данных/SQL/#7-почему-когда-много-индексов-это-плохо) [7%]
#### 8. [Плюсы и минусы индексов](Работа-с-базами-данных/SQL/#8-плюсы-и-минусы-индексов) [9%]
#### 9. [Какие виды индексов знаешь?](Работа-с-базами-данных/SQL/#9-какие-виды-индексов-знаешь) [14%]
...
#### 13. [Чем WHERE отличается от HAVING? Можем ли мы их использовать в одном запросе?](Работа-с-базами-данных/SQL/#13-чем-where-отличается-от-having) [7%]
...
#### 16. [EXPLAIN vs EXPLAIN ANALYZE](Работа-с-базами-данных/SQL/#16-explain-vs-explain-analyze) [11%]
...
#### 24. [View, materialized view. Разница между обычным и материализованным представлением?](Работа-с-базами-данных/SQL/#24-view-materialized-view-разница-между-обычным-и-материализованным-представлением) [3%]
...
#### 1. [Что такое Hibernate, JPA, JDBC, ORM?](Работа-с-базами-данных/ORM/#1-что-такое-hibernate-jpa-jdbc-orm) [5%]
...
#### 27. [Атрибут propagation у @Transactional](Архитектура-и-разработка/SPRING/#27-атрибут-propagation-у-transactional) [9%]
...
#### 32. [Starter в Spring. Плюсы и минусы](Архитектура-и-разработка/SPRING/#32-starter-в-spring-плюсы-и-минусы) [4%]
#### 33. [Spring Criteria API](Архитектура-и-разработка/SPRING/#33-spring-criteria-api) [3%]
...
#### 43. [@Configuration. Является Configuration компонентом? Какую доп логику Configuration реализует?](Архитектура-и-разработка/SPRING/#43-configuration-является-configuration-компонентом-какую-доп-логику-configuration-реализует) [1%]
...
#### 48. [Виды proxy в Spring](Архитектура-и-разработка/SPRING/#48-виды-proxy-в-spring) [5%]
...
#### 51. [@Lazy](Архитектура-и-разработка/SPRING/#51-lazy) [5%]
...
#### 1. [GOF паттерны](Принципы-и-методы-проектирования/Design-Patterns/#1-gof-паттерны) [11%]
...
#### 8. [Основные HTTP методы](Архитектура-и-разработка/WEB/#8-основные-http-методы) [7%]
...
## [Микросервисы](Архитектура-и-разработка/Microservices/#microservices) [22%]
...
#### 3. [Паттерн Saga в микросервисной архитектуре](Архитектура-и-разработка/Microservices/#3-паттерн-saga-в-микросервисной-архитектуре) [5%]
...
#### 9. [Что такое Transactional Outbox](Архитектура-и-разработка/Microservices/#9-что-такое-transactional-outbox) [3%]
...
#### 12. [Брокеры сообщений vs Rest](Архитектура-и-разработка/Message-broker/#12-брокеры-сообщений-vs-rest) [5%]
...
#### 7. [Для чего нужен Reflection?](Прочее/Other/#7-для-чего-нужен-reflection) [5%]
#### 8. [Что такое идемпотентность?](Прочее/Other/#8-что-такое-идемпотентность) [3%]
