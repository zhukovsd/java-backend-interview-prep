...
#### 18. [Разница между String, StringBuffer, StringBuilder](Основы-Java/java-core/#18-разница-между-string-stringbuffer-stringbuilder) [5%]
...
#### 25. [Что можно изменить в сигнатуре метода при переопределении? Можно ли менять модификаторы (throws и т. п.)?](Основы-Java/java-core/#25-что-можно-изменить-в-сигнатуре-метода-при-переопределении-можно-ли-менять-модификаторы-throws-и-т-п) [1%]
...
#### 27. [Что такое абстрактные классы?](Основы-Java/java-core/#27-что-такое-абстрактные-классы) [2%]
...
## [Коллекции](Основы-Java/Collections/#collections) [56%]
...
#### 17. [Будет ли работать HashMap, если все добавляемые ключи будут иметь одинаковый hashCode()?](Основы-Java/Collections/#17-будет-ли-работать-hashmap-если-все-добавляемые-ключи-будут-иметь-одинаковый-hashcode) [15%]
#### 18. [Ключи в HashMap](Основы-Java/Collections/#18-ключи-в-hashmap) [6%]
...
#### 23. [Процесс добавления объекта в HashSet?](Основы-Java/Collections/#23-процесс-добавления-объекта-в-hashset) [1%]
...
#### 38. [Структуры данных. Какая сложность в дереве?](Основы-Java/Collections/#38-структуры-данных-какая-сложность-в-дереве) [3%]
...
#### 13. [Atomic vs Volatile. Что это и когда использовать?](Основы-Java/Multithreading/#13-atomic-vs-volatile-что-это-и-когда-использовать) [6%]
...
#### 6. [Гарантии доставки в Kafka](Архитектура-и-разработка/Message-broker/#6-гарантии-доставки-в-kafka) [10%]
...
#### 8. [Основные компоненты Kafka?](Архитектура-и-разработка/Message-broker/#8-основные-компоненты-kafka) [13%]
...
#### 13. [Как гарантировать в Kafka идемпотентность, чтобы не было задвоений и потерь сообщений?](Архитектура-и-разработка/Message-broker/#13-как-гарантировать-в-kafka-идемпотентность-чтобы-не-было-задвоений-и-потерь-сообщений) [6%]
