...
#### 1. [Расскажи мне про контракт и свойства Equals & Hashcode](Основы-Java/java-core/#1-расскажи-мне-про-контракт-и-свойства-equalshashcode) [19%]
...
#### 24. [Какие есть модификаторы доступа? Какие применимы к классам?](Основы-Java/java-core/#24-какие-есть-модификаторы-доступа-какие-применимы-к-классам) [4%]
#### 25. [Что означает static?](Основы-Java/java-core/#25-что-означает-static) [5%]
...
## [Коллекции](Основы-Java/Collections/#collections) [57%]

#### 1. [Расскажите как выглядит иерархия коллекций](Основы-Java/Collections/#1-расскажите-как-выглядит-иерархия-коллекций) [21%]
#### 2. [Что такое ArrayList?](Основы-Java/Collections/#2-что-такое-arraylist) [5%]
...
#### 10. [Какая скорость вставки в ArrayList и LinkedList](Основы-Java/Collections/#10-какая-скорость-вставки-в-arraylist-и-linkedlist) [0%]
#### 11. [Что такое TreeMap?](Основы-Java/Collections/#11-что-такое-treemap) [2%]
#### 12. [TreeMap - сложность операций](Основы-Java/Collections/#12-treemap---сложность-операций) [1%]
#### 13. [Внутреннее устройство TreeMap](Основы-Java/Collections/#13-внутреннее-устройство-treemap) [3%]
#### 14. [Что такое HashMap?](Основы-Java/Collections/#14-что-такое-hashmap) [10%]
#### 15. [Внутреннее устройство HashMap](Основы-Java/Collections/#15-внутреннее-устройство-hashmap) [16%]
...
#### 20. [Ключи в HashMap](Основы-Java/Collections/#20-ключи-в-hashmap) [6%]
...
#### 23. [Как HashSet связан с HashMap?](Основы-Java/Collections/#23-как-hashset-связан-с-hashmap) [0%]
...
#### 26. [Процесс добавления объекта в HashSet?](Основы-Java/Collections/#26-процесс-добавления-объекта-в-hashset) [0%]
...
#### 36. [HashMap vs TreeMap](Основы-Java/Collections/#36-hashmap-vs-treemap) [3%]
...
#### 5. [Что такое промежуточные методы? Какие промежуточные методы в стримах вы знаете](Основы-Java/Stream-API/#5-что-такое-промежуточные-методы-какие-промежуточные-методы-в-стримах-вы-знаете) [4%]
...
#### 7. [Что такое CompletableFuture?](Основы-Java/Multithreading/#7-что-такое-completablefuture) [0%]
...
#### 15. [Зачем нужны atomic](Основы-Java/Multithreading/#15-зачем-нужны-atomic) [15%]
#### 16. [Зачем нужны volatile](Основы-Java/Multithreading/#16-зачем-нужны-volatile) [18%]
...
#### 19. [Какими способами можем запустить несколько потоков в Java приложении? Как запустить поток в Java?](Основы-Java/Multithreading/#19-какими-способами-можем-запустить-несколько-потоков-в-java-приложении-как-запустить-поток-в-java) [7%]
#### 20. [Что за интерфейсы Runnable и Callable? В чем между ними отличия?](Основы-Java/Multithreading/#20-что-за-интерфейсы-runnable-и-callable-в-чем-между-ними-отличия) [4%]
...
#### 24. [Что такое CAS операции? (Compare And Swap)](Основы-Java/Multithreading/#24-что-такое-cas-операции-compare-and-swap) [4%]
...
#### 27. [Что значит потокобезопасность?](Основы-Java/Multithreading/#27-что-значит-потокобезопасность) [0%]
...
#### 7. [Почему когда много индексов, это плохо?](Работа-с-базами-данных/SQL/#7-почему-когда-много-индексов-это-плохо) [0%]
#### 8. [Плюсы и минусы индексов](Работа-с-базами-данных/SQL/#8-плюсы-и-минусы-индексов) [8%]
#### 9. [Какие виды индексов знаешь?](Работа-с-базами-данных/SQL/#9-какие-виды-индексов-знаешь) [14%]
#### 10. [Как правильно выбрать индекс?](Работа-с-базами-данных/SQL/#10-как-правильно-выбрать-индекс) [3%]
#### 11. [Нормализация и денормализация. Перечислите формы](Работа-с-базами-данных/SQL/#11-нормализация-и-денормализация-перечислите-формы) [7%]
...
#### 18. [Что такое селективность?](Работа-с-базами-данных/SQL/#18-что-такое-селективность) [4%]
...
#### 25. [C помощью SQL блокировка строки? - SELECT FOR UPDATE](Работа-с-базами-данных/SQL/#25-c-помощью-sql-блокировка-строки---select-for-update) [5%]
...
#### 32. [Primary Key](Работа-с-базами-данных/SQL/#32-primary-key) [3%]
...
#### 5. [Почему лучше использовать конструктор?](Архитектура-и-разработка/SPRING/#5-почему-лучше-использовать-конструктор) [12%]
...
#### 12. [@ComponentScan](Архитектура-и-разработка/SPRING/#12-componentscan) [4%]
...
#### 21. [Spring Boot vs Spring](Архитектура-и-разработка/SPRING/#21-spring-boot-vs-spring) [9%]
...
#### 26. [Какие есть атрибуты у @Transactional?](Архитектура-и-разработка/SPRING/#26-какие-есть-атрибуты-у-transactional) [0%]
#### 27. [Атрибут propagation у @Transactional](Архитектура-и-разработка/SPRING/#27-атрибут-propagation-у-transactional) [9%]
#### 28. [@Transaction Что будет если вызвать метод из метода в одном классе при различных сценариях](Архитектура-и-разработка/SPRING/#28-transaction-что-будет-если-вызвать-метод-из-метода-в-одном-классе-при-различных-сценариях) [13%]
...
#### 30. [@Transactional и Исключения](Архитектура-и-разработка/SPRING/#30-transactional-и-исключения) [0%]
...
#### 34. [@Scheduled](Архитектура-и-разработка/SPRING/#34-scheduled) [3%]
...
#### 41. [Как работает DispatcherServlet?](Архитектура-и-разработка/SPRING/#41-как-работает-dispatcherservlet) [3%]
...
#### 13. [Паттерн Builder](Принципы-и-методы-проектирования/Design-Patterns/#13-паттерн-builder) [0%]
...
## [Микросервисы](Архитектура-и-разработка/Microservices/#microservices) [21%]

#### 1. [Монолит vs Микросервис](Архитектура-и-разработка/Microservices/#1-монолит-vs-микросервис) [4%]
#### 2. [Плюсы и минусы микросервисов](Архитектура-и-разработка/Microservices/#2-плюсы-и-минусы-микросервисов) [0%]
...
#### 4. [CAP теорема](Архитектура-и-разработка/Microservices/#4-cap-теорема) [1%]
...
#### 8. [Шаблоны проектирования для микросервисов (паттерны)](Архитектура-и-разработка/Microservices/#8-шаблоны-проектирования-для-микросервисов-паттерны) [5%]
