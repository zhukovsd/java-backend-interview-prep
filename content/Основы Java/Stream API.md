...
---
#### 8. Разница между parallel и parallelStream?
...
|---|---|---|---|
|`Consumer<T>`|Принимает `T`|Ничего не возвращает (`void`)|Используется, когда нужно выполнить действие без возвращения результата.|
...
**Пример использования `Consumer<T>`: печать списка элементов**
...
**Пример использования `Function<T, R>`: преобразование строки в ее длину**
...
**Пример использования `Supplier<T>`: генерация случайного числа**
