...
---
#### 15. Оконные функции. PARTITION BY	
...
---
#### 19. View, materialized view. представлениями, материализованными представлениями?
...
---	
#### 20. C помощью SQL блокировка строки? - SELECT FOR UPDATE	
...
---
#### 22. Расскажи про ключевое слово DISTINCT?	
...
---
#### 23. Что такое табличные выражения?
...
---
#### 24. Для чего используется Database Connection Pool? (Hikari) Переполнение connection pool	
...
---
#### 25. Блокировки и локи. Оптимистичная и Пессимистичная
...
---
#### 26. БД. Constraint. Какие существуют?	
